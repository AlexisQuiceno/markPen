<template>
    <!-- component -->
<footer class="bg-gradient-to-r from-gray-100 via-[#bce1ff] to-gray-300">
  <div class="max-w-screen-xl px-4 py-4 mx-auto sm:px-50 lg:px-4 scroll-pt-9">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 ">
      <div>
        ...
        <div class="flex mt-8 space-x-6 text-gray-600">
          ...
          <a class="hover:opacity-75" href="https://www.instagram.com/" target="_blank" rel="noreferrer">
