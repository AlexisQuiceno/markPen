            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-0 xl:mx-4 xl:w-1/2 md:grid-cols-2">
                <div>
                    ...
                    <div class="flex mt-8 space-x-6 text-gray-600">
                        ...
                        <a class="hover:opacity-75" href="https://twitter.com/" target="_blank" rel="noreferrer">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fillRule="evenodd" d="M7.3,0.9c1.5,-0.6 3.1,-0.9 4.7,-0.9c1.6,0 3.2,0.3 4.7,0.9c1.5,0.6 2.8,1.5
                ...
                <div>
                    ...
                    <h1 class="mt-4 text-2xl font-semibold text-gray-700 capitalize dark:text-white">Yonier Alexis</h1>
